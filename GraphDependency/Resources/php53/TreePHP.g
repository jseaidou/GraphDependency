...
top_statement
  ...
  | ^(NAMESPACE_T fully_qualified_class_name)
  ;
...
class_declaration_statement returns [ClassDeclaration classDeclaration, InterfaceDeclaration interfaceDeclaration, TraitDeclaration traitDeclaration]
  ...
  | ^(TRAIT_T IDENTIFIER (^(TRAIT_BODY class_statement_list))? )
     {
        int startIndex = $TRAIT_T.startIndex;
        int endIndex = $TRAIT_T.endIndex + 1;
        ...
        $traitDeclaration = new TraitDeclaration(startIndex ,endIndex, traitNameLeft, traitNameRight, className, new Block(traitNameRight,traitNameRight,null), null);
        parser.addDeclarationStatement($traitDeclaration);
        parser.declarations.push($traitDeclaration);
     }
  ;
...
@init {
  ...
  : ^(FIELD_DECL {inClassStatementList = true;} variable_modifiers static_var_element+ {inClassStatementList = false;})
  {
    ...
    AST tree = (AST)$variable_modifiers.tree;
    if(tree != null) {
...
//        }
  ...
  | ^(USE_DECL {inClassStatementList = true;} fully_qualified_class_name_list trait_adaptations {inClassStatementList = false;} )
  {
    int startIndex = $USE_DECL.startIndex;
    int endIndex = $USE_DECL.endIndex;
  }
  ;

trait_adaptations
  : ^(TRAIT_T trait_adaptation*)
  ;

trait_adaptation
  : ^(INSTANCEOF_T fully_qualified_class_name fully_qualified_class_name_list)
  | ^(TRAIT_METH fully_qualified_class_name AS_T modifier? IDENTIFIER?)
  ;
...
@init {
  ...
  | ^(DO_T ^(CONDITION e=expression) statement)
  {
    ...
    $stat = new DoWhileStatement(startIndex, endIndex, $e.expr, $statement.stat);      
  }
...
fully_qualified_class_name returns [String name, TypeReference type, SimpleReference simpleRef, ConstStaticAccess constant]
  : ^(d=DOMAIN_T f=fully_qualified_class_name IDENTIFIER) DOMAIN_T?
  {
    ...
    $constant = new ConstStaticAccess(startIndex, endIndex, type, constRef);
...
catch_branch
  : ^(CATCH_T fully_qualified_class_name variable block)
  {
    ...
    CatchStatement catchStatement = new CatchStatement(startIndex, endIndex, $fully_qualified_class_name.type, (VariableReference)$variable.var, (Block)$block.stat);
    $catch_branch_list::list.add(catchStatement);
  }
  ;
...
parameter
  : ^(PARAMETER (^(TYPE parameter_type))? CONST_T? pure_variable scalar?)
  {
    ...
    if ($scalar.expr == null) {
      if ($pure_variable.isRef) {
        $parameter_list::paramList.add(new FunctionFormalParameterByReference(startIndex, endIndex, classType, var));
      }
      else {
        $parameter_list::paramList.add(new FunctionFormalParameter(startIndex, endIndex, classType, var));
      }
    }
    else {
      if ($pure_variable.isRef) {
        $parameter_list::paramList.add(new FunctionFormalParameterByReference(startIndex, endIndex, classType, var, $scalar.expr));
      }
      else {
        $parameter_list::paramList.add(new FunctionFormalParameter(startIndex, endIndex, classType, var, $scalar.expr));
      }
    }
  }
  ;
...
//}
  ...
  | ^(OR_T e1=expression e2=expression)
  {
    ...
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.STRING_OR, expr2); 
  }
  | ^(XOR_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.STRING_XOR, expr2);
  }
  | ^(AND_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.STRING_AND, expr2);
  }
  | ^(EQUAL_T e1=expression e2=expression) 
  {
    ...
    if ($e2.text.startsWith("&")) {
      $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.REF_EQUAL, expr);
    }
    else {
      $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.EQUAL, expr);
    }
  }
  | ^(PLUS_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.PLUS_EQUAL, expr);
  }
  | ^(MINUS_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.MINUS_EQUAL, expr);
  }
  | ^(MUL_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.MULT_EQUAL, expr);
  }
  | ^(DIV_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.DIV_EQUAL, expr);
  }
  | ^(DOT_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.CONCAT_EQUAL, expr);
  }
  | ^(PERCENT_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.MOD_EQUAL, expr);
  }
  | ^(BIT_AND_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.AND_EQUAL, expr);
  }
  | ^(BIT_OR_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.OR_EQUAL, expr);
  }
  | ^(POWER_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.XOR_EQUAL, expr);
  }
  | ^(LMOVE_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.LSHIFT_EQUAL, expr);
  }
  | ^(RMOVE_EQ e1=expression e2=expression)
  {
    ...
    Expression var = $e1.expr;
    Expression expr = $e2.expr;
    $expr = new AssignmentExpression(startIndex, endIndex, var, AssignmentEnum.RSHIFT_EQUAL, expr);
  }
  ...
  | ^(LOGICAL_OR_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.BOOL_OR, expr2); 
  }
  | ^(LOGICAL_AND_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.BOOL_AND, expr2);
  }
  | ^(BIT_OR_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.OR, expr2); 
  }
  | ^(POWER_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.XOR, expr2); 
  }
  | ^(REF_T e1=expression e2=expression)
  {
    ...
    Expression expr2 = $e2.expr;
//    if (expr2 != null) {
      $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.AND, expr2);
//    }
//    else {
...
//    }
  ...
  | ^(UNARY_EXPR unary_symbol_list e=expression)
  {
    ...
    while (iter.hasNext()) {
      ...
      switch(symbolIndex) {
        case 1:
          $expr = new UnaryOperation(startIndex--, endIndex, $expr, UnaryOperationEnum.UOP_PLUS);
          break;
        case 2:
          $expr = new UnaryOperation(startIndex--, endIndex, $expr, UnaryOperationEnum.UOP_MINUS);
          break;
        case 3:
          ...
          break;
        case 4:
          $expr = new UnaryOperation(startIndex--, endIndex, $expr, UnaryOperationEnum.UOP_TILDA);
          break;
        case 5:
          $expr = new UnaryOperation(startIndex--, endIndex, $expr, UnaryOperationEnum.UOP_BANG);
          break;
        default:
          break;
      }
  ...
  | ^(DOT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.CONCAT, expr2); 
  }
  | ^(EQUAL_EQUAL_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.IS_EQUAL, expr2);
  }
  | ^(NOT_EQUAL_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.IS_NOT_EQUAL, expr2);
  }
  | ^(EQUAL_EQUAL_EQUAL_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.IS_IDENTICAL, expr2);
  }
  | ^(NOT_EQUAL_EQUAL_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.IS_NOT_IDENTICAL, expr2);
  }
  | ^(LT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.LESS_THAN, expr2); 
  }
  | ^(MT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.GREATER_THAN, expr2); 
  }
  | ^(LE_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.LESS_EQUAL, expr2); 
  }
  | ^(ME_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1 , InfixEnum.GREATER_EQUAL, expr2); 
  }
  | ^(LSHIFT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.LSHIFT, expr2); 
  }
  | ^(RSHIFT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.RSHIFT, expr2); 
  }
  | ^(PLUS_T e1=expression e2=expression)
  {
    ...
    Expression expr2 = $e2.expr;
//    if (expr2 != null) {
      $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.PLUS, expr2);
//    }
//    else {
//      $expr = new UnaryOperation(startIndex, endIndex, $e1.expr , UnaryOperationEnum.UOP_PLUS);
//    }
  }
  | ^(MINUS_T e1=expression e2=expression)
  {
    ...
    Expression expr2 = $e2.expr;
//    if (expr2 != null) {
      $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.MINUS, expr2);
//    }
//    else {
//      $expr = new UnaryOperation(startIndex, endIndex, $e1.expr , UnaryOperationEnum.UOP_MINUS);
//    }
  }
  | ^(MUL_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.MULT, expr2);
  }
  | ^(DIV_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.DIV, expr2);
  }
  | ^(PERCENT_T e1=expression e2=expression)
  {
    ...
    Expression expr1 = $e1.expr;
    Expression expr2 = $e2.expr;
    $expr = new InfixExpression(startIndex, endIndex, expr1, InfixEnum.MOD, expr2);
  }
  | ^(CAST_EXPR cast_option e=expression)
  {
    ...
    switch(result) {
      case 1:
      case 2:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.BOOL);
        break;
      case 3:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.INT);
        break;
      case 6:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.ARRAY);
        break;
      case 7:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.OBJECT);
        break;
      case 8:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.REAL);
        break;
      case 9:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.STRING);
        break;
      case 10:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.UNSET);
        break;
      default:
        $expr = new CastExpression(startIndex, endIndex, expr, CastEnum.OBJECT);
        break;
...
//      $expr = new UnaryOperation(startIndex, endIndex, $e.expr , UnaryOperationEnum.UOP_TILDA);
//  }
//  | ^(EXC_NOT_T e=expression)
//  {
//      int startIndex = $EXC_NOT_T.startIndex;
//      int endIndex = $EXC_NOT_T.endIndex + 1;
//      $expr = new UnaryOperation(startIndex, endIndex, $e.expr , UnaryOperationEnum.UOP_BANG);
//  }
  | ^(POSTFIX_EXPR e=expression plus_minus)
  {
      ...
      if ($plus_minus.text.equals("++")) {
        $expr = new PostfixExpression(startIndex, endIndex, $e.expr , PostfixEnum.INC);
      }
      else {
        $expr = new PostfixExpression(startIndex, endIndex, $e.expr , PostfixEnum.DEC);
      } 
  }
  | ^(PREFIX_EXPR plus_minus+ e=expression)
  {
      ...
      if ($plus_minus.text.equals("++")) {
        $expr = new PrefixExpression(startIndex, endIndex, $e.expr, PrefixEnum.INC);
      }
      else {
        $expr = new PrefixExpression(startIndex, endIndex, $e.expr, PrefixEnum.DEC);
      }
  }
...
@after {
  ...
  | ^(INDEX obj=object_property expression?)
  {
    ...
    if ($expression.text != null) {
      if(varName.getKind() == ExpressionConstants.E_IDENTIFIER) {
         $expr = new ArrayVariableReference(startIndex, endIndex, ((SimpleReference)varName).getName(), index, ArrayVariableRefEnum.ARRAY);
      } else {
         $expr = new ReflectionArrayVariableReference(startIndex, endIndex, varName, index, ReflectionArrayEnum.ARRAY);
      }
    }
    else {
       $expr = new ArrayVariableReference(startIndex, endIndex, ((SimpleReference)varName).getName(), index, ArrayVariableRefEnum.ARRAY);
  ...
  | ^(HASH_INDEX obj=object_property expression?)
  {
    ...
    if ($expression.text != null) {
      if(varName.getKind() == ExpressionConstants.E_IDENTIFIER) {
         $expr = new ArrayVariableReference(startIndex, endIndex, ((SimpleReference)varName).getName(), index, ArrayVariableRefEnum.HASHTABLE);
      } else {
         $expr = new ReflectionArrayVariableReference(startIndex, endIndex, varName, index, ReflectionArrayEnum.HASHTABLE);
      }
    }
    else {
       $expr = new ArrayVariableReference(startIndex, endIndex, ((SimpleReference)varName).getName(), index, ArrayVariableRefEnum.HASHTABLE);
...
constant returns [Scalar scalar, Expression expr]
  :   INTLITERAL
  {
    ...
    $scalar = new Scalar(startIndex, endIndex, $INTLITERAL.text, ScalarEnum.INT);
  }
  |   FLOATLITERAL
  {
    ...
    int startIndex = token.getStartIndex();
    int endIndex = token.getStopIndex() + 1;
    $scalar = new Scalar(startIndex, endIndex, $FLOATLITERAL.text, ScalarEnum.REAL);
  }
  |   STRINGLITERAL
  {
    ...
    int startIndex = token.getStartIndex();
    int endIndex = token.getStopIndex() + 1;
    $scalar = new Scalar(startIndex, endIndex, $STRINGLITERAL.text, ScalarEnum.STRING);
  }
//  |   QUOTE_STRING
//  {
...
//    int startIndex = token.getStartIndex();
//    int endIndex = token.getStopIndex() + 1;
//    $expr = parseQuote($QUOTE_STRING.text.substring(1, $QUOTE_STRING.text.length() - 1), startIndex, endIndex, ComplexQuote.QUOTE);
//    if ($expr == null) {
//      $scalar = new Scalar(startIndex, endIndex, $QUOTE_STRING.text, ScalarEnum.STRING);
//    }
//  }
  |   REALLITERAL
  {
    ...
    int startIndex = token.getStartIndex();
    int endIndex = token.getStopIndex() + 1;
    $scalar = new Scalar(startIndex, endIndex, $REALLITERAL.text, ScalarEnum.REAL);
  }
  ...
  |   DOUBLELITERRAL
  {
    ...
    int startIndex = token.getStartIndex();
    int endIndex = token.getStopIndex() + 1;
    $scalar = new Scalar(startIndex, endIndex, $DOUBLELITERRAL.text, ScalarEnum.REAL);
  }
  |   common_scalar
  {
      ...
      int startIndex = token.getStartIndex();
      int endIndex = token.getStopIndex() + 1;
      $scalar = new Scalar(startIndex, endIndex, $common_scalar.text, ScalarEnum.SYSTEM);
  }
  |   IDENTIFIER
  {
      CommonToken token = (CommonToken)$IDENTIFIER.token;
        int startIndex = token.getStartIndex();
        int endIndex = token.getStopIndex() + 1;
        $scalar = new Scalar(startIndex, endIndex, $IDENTIFIER.text, ScalarEnum.STRING);
  }
  |   fully_qualified_class_name
  {
  ...
  {
    System.out.println("ID: " + $id1.text);
    CommonToken token = (CommonToken)$HEREDOC_START.token;
    int startIndex = token.getStartIndex();
    int endIndex = token.getStopIndex();
    List list = new LinkedList();
    list.add(new Scalar( ((CommonToken)$id1.token).getStartIndex(), ((CommonToken)$id1.token).getStopIndex(), $id1.text, ScalarEnum.STRING));
    $expr = new ComplexQuote(startIndex, endIndex, list, ComplexQuote.HEREDOC);
  }  
//  {
//    CommonToken token = (CommonToken)$HEREDOC.token;
//    int startIndex = token.getStartIndex();
//    int endIndex = token.getStopIndex();
//    
//    int labelStart = $HEREDOC.text.indexOf($id3.text);
//    String label = $HEREDOC.text.substring(labelStart, labelStart + $id3.text.length());
//    int index1 = startIndex + labelStart + label.length() + 1;
//    CommonToken id3Token = (CommonToken)$id3.token;
//    int index2 = id3Token.getStopIndex() - $id3.text.length(); 
//    
//    List list = new LinkedList();
//    if(index1 < index2) {
//        Scalar scalar = new Scalar( index1, endIndex - 1, $id2.getText(), ScalarEnum.STRING);
//        list.add(scalar);
//    }
//    int id1IndexStart = id1Token.getStartIndex() + startIndex + 1;
//    int id1IndexEnd = id1Token.getStopIndex(); 
//    Scalar id1Scalar = new Scalar(id1IndexStart, id1IndexEnd, $id1.text, ScalarEnum.STRING);
//    
//    CommonToken id2Token = (CommonToken)$id2.token;
//    int id2IndexStart = id2Token.getStartIndex() + startIndex + 1;
//    int id2IndexEnd = id2Token.getStopIndex(); 
//    
//    CommonToken id3Token = (CommonToken)$id3.token;
//    int id3IndexStart = id2Token.getStartIndex() + startIndex + 1;
//    int id3IndexEnd = id3Token.getStopIndex(); 
//    Scalar id3Scalar = new Scalar(id3IndexStart, id3IndexEnd, $id3.text, ScalarEnum.STRING);
