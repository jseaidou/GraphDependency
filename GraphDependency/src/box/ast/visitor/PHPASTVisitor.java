...
public abstract class PHPASTVisitor extends ASTVisitor {
    ...
    public boolean endvisit(FunctionFormalParameterByReference s) throws Exception {
        endvisitGeneral(s);
        return false;
    }
    ...
    public boolean endvisit(ASTNode s) throws Exception {
        ...
        if (nodeClass.equals(AssignmentExpression.class)) {
            return endvisit((AssignmentExpression) s);
        }
        ...
        if (nodeClass.equals(CatchStatement.class)) {
            return endvisit((CatchStatement) s);
        }
        ...
        if (nodeClass.equals(DoWhileStatement.class)) {
            return endvisit((DoWhileStatement) s);
        }
        ...
        if (nodeClass.equals(FunctionFormalParameter.class)) {
            return endvisit((FunctionFormalParameter) s);
        }
        if (nodeClass.equals(FunctionFormalParameterByReference.class)) {
            return endvisit((FunctionFormalParameterByReference) s);
        }
        ...
        if (nodeClass.equals(ComplexQuote.class)) {
            return endvisit((ComplexQuote) s);
        }
        ...
        if (nodeClass.equals(ConstStaticAccess.class)) {
            return endvisit((ConstStaticAccess) s);
        }
    ...
    public boolean visit(ASTNode s) throws Exception {
        ...
        if (nodeClass.equals(AssignmentExpression.class)) {
            return visit((AssignmentExpression) s);
        }
        if (nodeClass.equals(ASTError.class)) {
        ...
        if (nodeClass.equals(DoWhileStatement.class)) {
            return visit((DoWhileStatement) s);
        }
        if (nodeClass.equals(EchoStatement.class)) {
        ...
        if (nodeClass.equals(FunctionFormalParameter.class)) {
            return visit((FunctionFormalParameter) s);
        }
        if (nodeClass.equals(FunctionFormalParameterByReference.class)) {
            return visit((FunctionFormalParameterByReference) s);
        }
        if (nodeClass.equals(ForStatement.class)) {
        ...
        if (nodeClass.equals(ConstStaticAccess.class)) {
            return visit((ConstStaticAccess) s);
        }
        if (nodeClass.equals(StaticDispatch.class)) {
