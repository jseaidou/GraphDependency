// $ANTLR 3.5.2 TreePHP.g 2014-06-27 03:38:18
...
public class TreePHP extends TreeParser {
	...
	@Override public String getGrammarFileName() { return "TreePHP.g"; }
	...
	// TreePHP.g:203:1: php_source : ^( ModuleDeclaration ( top_statement_list )? ) ;
	public final TreePHP.php_source_return php_source() throws RecognitionException {
		...
		try {
			// TreePHP.g:204:3: ( ^( ModuleDeclaration ( top_statement_list )? ) )
			// TreePHP.g:204:6: ^( ModuleDeclaration ( top_statement_list )? )
			{
			...
			if ( input.LA(1)==Token.DOWN ) {
				...
				// TreePHP.g:204:26: ( top_statement_list )?
				int alt1=2;
	...
	// TreePHP.g:218:1: top_statement_list : ( top_statement )+ ;
	public final TreePHP.top_statement_list_return top_statement_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:219:3: ( ( top_statement )+ )
			// TreePHP.g:219:5: ( top_statement )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:222:1: top_statement : ( statement | function_declaration_statement | class_declaration_statement | halt_compiler_statement | ^( NAMESPACE_T fully_qualified_class_name ) );
	public final TreePHP.top_statement_return top_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:223:3: ( statement | function_declaration_statement | class_declaration_statement | halt_compiler_statement | ^( NAMESPACE_T fully_qualified_class_name ) )
			int alt3=5;
			switch ( input.LA(1) ) {
			case STATEMENT:
				{
			...
			switch (alt3) {
				case 1 :
					...
					break;
				case 2 :
					// TreePHP.g:228:5: function_declaration_statement
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 3 :
					// TreePHP.g:232:5: class_declaration_statement
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:247:5: halt_compiler_statement
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 5 :
					// TreePHP.g:248:5: ^( NAMESPACE_T fully_qualified_class_name )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:251:1: inner_statement_list returns [List innerStatementList] : ( inner_statement )+ ;
	public final TreePHP.inner_statement_list_return inner_statement_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:258:3: ( ( inner_statement )+ )
			// TreePHP.g:258:5: ( inner_statement )+
			{
			root_0 = (AST)adaptor.nil();
			...
			while (true) {
				...
				switch (alt4) {
				case 1 :
					// TreePHP.g:258:6: inner_statement
					{
					_last = (AST)input.LT(1);
	...
	// TreePHP.g:264:1: inner_statement : ( statement | function_declaration_statement | class_declaration_statement | halt_compiler_statement );
	public final TreePHP.inner_statement_return inner_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:265:3: ( statement | function_declaration_statement | class_declaration_statement | halt_compiler_statement )
			int alt5=4;
			switch ( input.LA(1) ) {
			case STATEMENT:
				{
			...
			switch (alt5) {
				case 1 :
					...
					break;
				case 2 :
					// TreePHP.g:271:5: function_declaration_statement
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 3 :
					// TreePHP.g:277:5: class_declaration_statement
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:283:5: halt_compiler_statement
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:286:1: halt_compiler_statement : '__halt_compiler' ;
	public final TreePHP.halt_compiler_statement_return halt_compiler_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:287:3: ( '__halt_compiler' )
			// TreePHP.g:287:5: '__halt_compiler'
			{
			root_0 = (AST)adaptor.nil();
	...
	public final TreePHP.class_declaration_statement_return class_declaration_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:291:3: ( ^( CLASS_T ( class_entr_type )? IDENTIFIER ( ^( EXTENDS_T fully_qualified_class_name ) )? ( ^( IMPLEMENTS_T fully_qualified_class_name_list ) )? ( ^( CLASS_BODY class_statement_list ) )? ) | ^( INTERFACE_T IDENTIFIER ( ^( EXTENDS_T fully_qualified_class_name_list ) )? ( ^( CLASS_BODY class_statement_list ) )? ) | ^( TRAIT_T IDENTIFIER ( ^( TRAIT_BODY class_statement_list ) )? ) )
			int alt13=3;
			switch ( input.LA(1) ) {
			case CLASS_T:
				{
			...
			switch (alt13) {
				case 1 :
					// TreePHP.g:291:5: ^( CLASS_T ( class_entr_type )? IDENTIFIER ( ^( EXTENDS_T fully_qualified_class_name ) )? ( ^( IMPLEMENTS_T fully_qualified_class_name_list ) )? ( ^( CLASS_BODY class_statement_list ) )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					match(input, Token.DOWN, null); 
					// TreePHP.g:291:15: ( class_entr_type )?
					int alt6=2;
					...
					// TreePHP.g:312:4: ( ^( EXTENDS_T fully_qualified_class_name ) )?
					int alt7=2;
					...
					switch (alt7) {
						case 1 :
							// TreePHP.g:312:5: ^( EXTENDS_T fully_qualified_class_name )
							{
							_last = (AST)input.LT(1);
							{
					...
					// TreePHP.g:312:47: ( ^( IMPLEMENTS_T fully_qualified_class_name_list ) )?
					int alt8=2;
					...
					switch (alt8) {
						case 1 :
							// TreePHP.g:312:48: ^( IMPLEMENTS_T fully_qualified_class_name_list )
							{
							_last = (AST)input.LT(1);
							{
							AST _save_last_2 = _last;
					...
					// TreePHP.g:313:7: ( ^( CLASS_BODY class_statement_list ) )?
					int alt9=2;
					...
					switch (alt9) {
						case 1 :
							// TreePHP.g:313:8: ^( CLASS_BODY class_statement_list )
							{
							_last = (AST)input.LT(1);
							{
							AST _save_last_2 = _last;
					...
					break;
				case 2 :
					// TreePHP.g:355:5: ^( INTERFACE_T IDENTIFIER ( ^( EXTENDS_T fully_qualified_class_name_list ) )? ( ^( CLASS_BODY class_statement_list ) )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:355:30: ( ^( EXTENDS_T fully_qualified_class_name_list ) )?
					int alt10=2;
					...
					switch (alt10) {
						case 1 :
							// TreePHP.g:355:31: ^( EXTENDS_T fully_qualified_class_name_list )
							{
							_last = (AST)input.LT(1);
							{
							AST _save_last_2 = _last;
					...
					// TreePHP.g:378:7: ( ^( CLASS_BODY class_statement_list ) )?
					int alt11=2;
					...
					switch (alt11) {
						case 1 :
							// TreePHP.g:378:8: ^( CLASS_BODY class_statement_list )
							{
							_last = (AST)input.LT(1);
							{
							AST _save_last_2 = _last;
					...
					break;
				case 3 :
					// TreePHP.g:382:5: ^( TRAIT_T IDENTIFIER ( ^( TRAIT_BODY class_statement_list ) )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:382:26: ( ^( TRAIT_BODY class_statement_list ) )?
					int alt12=2;
					...
					switch (alt12) {
						case 1 :
							// TreePHP.g:382:27: ^( TRAIT_BODY class_statement_list )
							{
							_last = (AST)input.LT(1);
							{
							AST _save_last_2 = _last;
	...
	// TreePHP.g:398:1: class_entr_type : ( 'abstract' | 'final' );
	public final TreePHP.class_entr_type_return class_entr_type() throws RecognitionException {
		...
		try {
			// TreePHP.g:399:3: ( 'abstract' | 'final' )
			// TreePHP.g:
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:403:1: class_statement_list : ( class_statement )+ ;
	public final TreePHP.class_statement_list_return class_statement_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:404:3: ( ( class_statement )+ )
			// TreePHP.g:404:5: ( class_statement )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:407:1: class_statement : ( ^( FIELD_DECL variable_modifiers ( static_var_element )+ ) | ^( METHOD_DECL modifier ( REF_T )? IDENTIFIER ( parameter_list )? ( block | EMPTYSTATEMENT ) ) | ^( FIELD_DECL CONST_T ( directive )+ ) | ^( USE_DECL fully_qualified_class_name_list trait_adaptations ) );
	public final TreePHP.class_statement_return class_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:416:3: ( ^( FIELD_DECL variable_modifiers ( static_var_element )+ ) | ^( METHOD_DECL modifier ( REF_T )? IDENTIFIER ( parameter_list )? ( block | EMPTYSTATEMENT ) ) | ^( FIELD_DECL CONST_T ( directive )+ ) | ^( USE_DECL fully_qualified_class_name_list trait_adaptations ) )
			int alt20=4;
			switch ( input.LA(1) ) {
			case FIELD_DECL:
				{
			...
			switch (alt20) {
				case 1 :
					// TreePHP.g:416:5: ^( FIELD_DECL variable_modifiers ( static_var_element )+ )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:416:68: ( static_var_element )+
					int cnt15=0;
					loop15:
					while (true) {
						int alt15=2;
					...
					break;
				case 2 :
					// TreePHP.g:446:5: ^( METHOD_DECL modifier ( REF_T )? IDENTIFIER ( parameter_list )? ( block | EMPTYSTATEMENT ) )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:470:7: ( parameter_list )?
					int alt17=2;
					...
					// TreePHP.g:477:5: ( block | EMPTYSTATEMENT )
					int alt18=2;
					...
					switch (alt18) {
						case 1 :
							...
							break;
						case 2 :
							// TreePHP.g:496:5: EMPTYSTATEMENT
							{
							_last = (AST)input.LT(1);
					...
					break;
				case 3 :
					// TreePHP.g:515:5: ^( FIELD_DECL CONST_T ( directive )+ )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:537:5: ^( USE_DECL fully_qualified_class_name_list trait_adaptations )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:544:1: trait_adaptations : ^( TRAIT_T ( trait_adaptation )* ) ;
	public final TreePHP.trait_adaptations_return trait_adaptations() throws RecognitionException {
		...
		try {
			// TreePHP.g:545:3: ( ^( TRAIT_T ( trait_adaptation )* ) )
			// TreePHP.g:545:5: ^( TRAIT_T ( trait_adaptation )* )
			{
			root_0 = (AST)adaptor.nil();
			...
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// TreePHP.g:545:15: ( trait_adaptation )*
				loop21:
				while (true) {
					int alt21=2;
	...
	// TreePHP.g:548:1: trait_adaptation : ( ^( INSTANCEOF_T fully_qualified_class_name fully_qualified_class_name_list ) | ^( TRAIT_METH fully_qualified_class_name AS_T ( modifier )? ( IDENTIFIER )? ) );
	public final TreePHP.trait_adaptation_return trait_adaptation() throws RecognitionException {
		...
		try {
			// TreePHP.g:549:3: ( ^( INSTANCEOF_T fully_qualified_class_name fully_qualified_class_name_list ) | ^( TRAIT_METH fully_qualified_class_name AS_T ( modifier )? ( IDENTIFIER )? ) )
			int alt24=2;
			...
			switch (alt24) {
				case 1 :
					// TreePHP.g:549:5: ^( INSTANCEOF_T fully_qualified_class_name fully_qualified_class_name_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:550:5: ^( TRAIT_METH fully_qualified_class_name AS_T ( modifier )? ( IDENTIFIER )? )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:553:1: function_declaration_statement returns [Statement stat] : ^( METHOD_DECL ( REF_T )? IDENTIFIER ( parameter_list )? block ) ;
	public final TreePHP.function_declaration_statement_return function_declaration_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:554:3: ( ^( METHOD_DECL ( REF_T )? IDENTIFIER ( parameter_list )? block ) )
			// TreePHP.g:554:5: ^( METHOD_DECL ( REF_T )? IDENTIFIER ( parameter_list )? block )
			{
			root_0 = (AST)adaptor.nil();
			...
			// TreePHP.g:574:4: ( parameter_list )?
			int alt26=2;
	...
	// $ANTLR start "block"
	// TreePHP.g:605:1: block returns [Statement stat, List statList] : ^( BLOCK ( inner_statement_list )? ) ;
	public final TreePHP.block_return block() throws RecognitionException {
		...
		try {
			// TreePHP.g:606:3: ( ^( BLOCK ( inner_statement_list )? ) )
			// TreePHP.g:606:5: ^( BLOCK ( inner_statement_list )? )
			{
			root_0 = (AST)adaptor.nil();
			...
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// TreePHP.g:606:13: ( inner_statement_list )?
				int alt27=2;
	...
	// TreePHP.g:623:1: statement returns [Statement stat] : ^( STATEMENT topStatement ) ;
	public final TreePHP.statement_return statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:624:3: ( ^( STATEMENT topStatement ) )
			// TreePHP.g:624:5: ^( STATEMENT topStatement )
			{
			root_0 = (AST)adaptor.nil();
	...
	public final TreePHP.topStatement_return topStatement() throws RecognitionException {
		...
		try {
			// TreePHP.g:650:3: ( block | if_stat | ^( WHILE_T ^( CONDITION e= expression ) while_statement ) | ^( DO_T ^( CONDITION e= expression ) statement ) | ^( FOR_T (e1= expr_list )? ^( CONDITION (e2= expr_list )? ) ^( ITERATE (e3= expr_list )? ) s1= for_statement ) | ^( SWITCH_T ^( CONDITION e= expression ) switch_case_list ) | ^( BREAK_T ( expression )? ) | ^( CONTINUE_T (e= expression )? ) | ^( RETURN_T (e= expression )? ) | ^( GLOBAL_T variable_list ) | ^( STATIC_T static_var_list ) | ^( ECHO_T expr_list ) | ^( EMPTYSTATEMENT SEMI_COLON ) | expression | ^( FOREACH_T ^( AS_T e= expression v1= foreach_variable (v2= foreach_variable )? ) foreach_statement ) | ^( DECLARE_T directive declare_statement ) | ^( TRY_T block catch_branch_list ) | ^( THROW_T e= expression ) | ^( USE_T scalar ) | ^( USE_PARETHESIS_T scalar ) | ^( INCLUDE_T e= expression ) | ^( INCLUDE_ONCE_T e= expression ) | ^( REQUIRE_T e= expression ) | ^( REQUIRE_ONCE_T e= expression ) )
			int alt35=24;
			switch ( input.LA(1) ) {
			case BLOCK:
				{
			...
			switch (alt35) {
				...
				case 2 :
					...
					break;
				case 3 :
					// TreePHP.g:658:5: ^( WHILE_T ^( CONDITION e= expression ) while_statement )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:665:5: ^( DO_T ^( CONDITION e= expression ) statement )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 5 :
					// TreePHP.g:671:5: ^( FOR_T (e1= expr_list )? ^( CONDITION (e2= expr_list )? ) ^( ITERATE (e3= expr_list )? ) s1= for_statement )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 6 :
					// TreePHP.g:683:5: ^( SWITCH_T ^( CONDITION e= expression ) switch_case_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 7 :
					// TreePHP.g:689:5: ^( BREAK_T ( expression )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 8 :
					// TreePHP.g:695:5: ^( CONTINUE_T (e= expression )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 9 :
					// TreePHP.g:704:5: ^( RETURN_T (e= expression )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 10 :
					// TreePHP.g:713:5: ^( GLOBAL_T variable_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 11 :
					// TreePHP.g:719:5: ^( STATIC_T static_var_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 12 :
					// TreePHP.g:725:5: ^( ECHO_T expr_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 13 :
					// TreePHP.g:731:5: ^( EMPTYSTATEMENT SEMI_COLON )
					{
					root_0 = (AST)adaptor.nil();
				...
				case 14 :
					...
					break;
				case 15 :
					// TreePHP.g:741:5: ^( FOREACH_T ^( AS_T e= expression v1= foreach_variable (v2= foreach_variable )? ) foreach_statement )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:741:59: (v2= foreach_variable )?
					int alt34=2;
					...
					break;
				case 16 :
					// TreePHP.g:753:5: ^( DECLARE_T directive declare_statement )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 17 :
					// TreePHP.g:760:5: ^( TRY_T block catch_branch_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 18 :
					// TreePHP.g:768:5: ^( THROW_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
				...
				case 19 :
					...
					break;
				case 20 :
					// TreePHP.g:785:5: ^( USE_PARETHESIS_T scalar )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 21 :
					// TreePHP.g:796:5: ^( INCLUDE_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 22 :
					// TreePHP.g:802:5: ^( INCLUDE_ONCE_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 23 :
					// TreePHP.g:808:5: ^( REQUIRE_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 24 :
					// TreePHP.g:814:5: ^( REQUIRE_ONCE_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:825:1: foreach_variable returns [Expression expr] : ( REF_T )? variable ;
	public final TreePHP.foreach_variable_return foreach_variable() throws RecognitionException {
		...
		try {
			// TreePHP.g:831:3: ( ( REF_T )? variable )
			// TreePHP.g:831:5: ( REF_T )? variable
			{
			root_0 = (AST)adaptor.nil();


			// TreePHP.g:831:5: ( REF_T )?
			int alt36=2;
	...
	// TreePHP.g:838:1: use_filename : ( STRINGLITERAL | QUOTE_STRING );
	public final TreePHP.use_filename_return use_filename() throws RecognitionException {
		...
		try {
			// TreePHP.g:839:3: ( STRINGLITERAL | QUOTE_STRING )
			// TreePHP.g:
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:843:1: variable_list returns [List variableList] : ( variable )+ ;
	public final TreePHP.variable_list_return variable_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:854:3: ( ( variable )+ )
			// TreePHP.g:854:5: ( variable )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:861:1: fully_qualified_class_name_list returns [List list] : ( fully_qualified_class_name )+ ;
	public final TreePHP.fully_qualified_class_name_list_return fully_qualified_class_name_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:872:3: ( ( fully_qualified_class_name )+ )
			// TreePHP.g:872:5: ( fully_qualified_class_name )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:879:1: fully_qualified_class_name returns [String name, TypeReference type, SimpleReference simpleRef, ConstStaticAccess constant] : ( ^(d= DOMAIN_T f= fully_qualified_class_name IDENTIFIER ) ( DOMAIN_T )? | IDENTIFIER ( DOMAIN_T )? );
	public final TreePHP.fully_qualified_class_name_return fully_qualified_class_name() throws RecognitionException {
		...
		try {
			// TreePHP.g:880:3: ( ^(d= DOMAIN_T f= fully_qualified_class_name IDENTIFIER ) ( DOMAIN_T )? | IDENTIFIER ( DOMAIN_T )? )
			int alt41=2;
			...
			switch (alt41) {
				case 1 :
					// TreePHP.g:880:5: ^(d= DOMAIN_T f= fully_qualified_class_name IDENTIFIER ) ( DOMAIN_T )?
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:913:5: IDENTIFIER ( DOMAIN_T )?
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:928:1: static_var_list returns [List staticVarList] : ( static_var_element )+ ;
	public final TreePHP.static_var_list_return static_var_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:935:3: ( ( static_var_element )+ )
			// TreePHP.g:935:5: ( static_var_element )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:941:1: static_var_element : ( pure_variable | ^( EQUAL_T pure_variable scalar ) );
	public final TreePHP.static_var_element_return static_var_element() throws RecognitionException {
		...
		try {
			// TreePHP.g:942:3: ( pure_variable | ^( EQUAL_T pure_variable scalar ) )
			int alt43=2;
			...
			switch (alt43) {
				case 1 :
					...
					break;
				case 2 :
					// TreePHP.g:957:5: ^( EQUAL_T pure_variable scalar )
					{
					root_0 = (AST)adaptor.nil();
	...
	// $ANTLR start "if_stat"
	// TreePHP.g:979:1: if_stat returns [Statement stat] : ^( IF_T ^( CONDITION expression ) ( ( inner_statement_list )? ( else_if_stat )* ( ^( ELSE_T statement ) )? ) ) ;
	public final TreePHP.if_stat_return if_stat() throws RecognitionException {
		...
		try {
			// TreePHP.g:990:3: ( ^( IF_T ^( CONDITION expression ) ( ( inner_statement_list )? ( else_if_stat )* ( ^( ELSE_T statement ) )? ) ) )
			// TreePHP.g:990:5: ^( IF_T ^( CONDITION expression ) ( ( inner_statement_list )? ( else_if_stat )* ( ^( ELSE_T statement ) )? ) )
			{
			root_0 = (AST)adaptor.nil();
			...
			// TreePHP.g:991:5: ( ( inner_statement_list )? ( else_if_stat )* ( ^( ELSE_T statement ) )? )
			// TreePHP.g:992:7: ( inner_statement_list )? ( else_if_stat )* ( ^( ELSE_T statement ) )?
			{
			// TreePHP.g:992:7: ( inner_statement_list )?
			int alt44=2;
			...
			// TreePHP.g:993:21: ( ^( ELSE_T statement ) )?
			int alt46=2;
			...
			switch (alt46) {
				case 1 :
					// TreePHP.g:993:22: ^( ELSE_T statement )
					{
					_last = (AST)input.LT(1);
					{
					AST _save_last_2 = _last;
	...
	// TreePHP.g:1022:1: else_if_stat : ^( ELSEIF_T ^( CONDITION expression ) ( inner_statement_list )? ) ;
	public final TreePHP.else_if_stat_return else_if_stat() throws RecognitionException {
		...
		try {
			// TreePHP.g:1023:3: ( ^( ELSEIF_T ^( CONDITION expression ) ( inner_statement_list )? ) )
			// TreePHP.g:1023:5: ^( ELSEIF_T ^( CONDITION expression ) ( inner_statement_list )? )
			{
			root_0 = (AST)adaptor.nil();
			...
			// TreePHP.g:1023:40: ( inner_statement_list )?
			int alt47=2;
	...
	// TreePHP.g:1040:1: switch_case_list returns [Block block] : ( case_list )+ ;
	public final TreePHP.switch_case_list_return switch_case_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1047:3: ( ( case_list )+ )
			// TreePHP.g:1047:5: ( case_list )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1058:1: case_list : ( ^( CASE_T e= expression ( inner_statement_list )? ) | ^( DEFAULT_T ( inner_statement_list )? ) );
	public final TreePHP.case_list_return case_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1059:3: ( ^( CASE_T e= expression ( inner_statement_list )? ) | ^( DEFAULT_T ( inner_statement_list )? ) )
			int alt51=2;
			...
			switch (alt51) {
				case 1 :
					// TreePHP.g:1059:5: ^( CASE_T e= expression ( inner_statement_list )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:1059:27: ( inner_statement_list )?
					int alt49=2;
					...
					break;
				case 2 :
					// TreePHP.g:1070:5: ^( DEFAULT_T ( inner_statement_list )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// TreePHP.g:1070:17: ( inner_statement_list )?
						int alt50=2;
	...
	// TreePHP.g:1083:1: catch_branch_list returns [List catchList] : ( catch_branch )+ ;
	public final TreePHP.catch_branch_list_return catch_branch_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1090:3: ( ( catch_branch )+ )
			// TreePHP.g:1090:5: ( catch_branch )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1096:1: catch_branch : ^( CATCH_T fully_qualified_class_name variable block ) ;
	public final TreePHP.catch_branch_return catch_branch() throws RecognitionException {
		...
		try {
			// TreePHP.g:1097:3: ( ^( CATCH_T fully_qualified_class_name variable block ) )
			// TreePHP.g:1097:5: ^( CATCH_T fully_qualified_class_name variable block )
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1106:1: for_statement returns [Statement block] : ( inner_statement_list )? ;
	public final TreePHP.for_statement_return for_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:1107:2: ( ( inner_statement_list )? )
			// TreePHP.g:1107:4: ( inner_statement_list )?
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1121:1: while_statement returns [Statement block] : ( inner_statement_list )? ;
	public final TreePHP.while_statement_return while_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:1122:3: ( ( inner_statement_list )? )
			// TreePHP.g:1122:5: ( inner_statement_list )?
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1135:1: foreach_statement returns [Statement block] : ( inner_statement_list )? ;
	public final TreePHP.foreach_statement_return foreach_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:1136:3: ( ( inner_statement_list )? )
			// TreePHP.g:1136:5: ( inner_statement_list )?
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1149:1: declare_statement returns [Statement block] : ^( BLOCK ( inner_statement_list )? ) ;
	public final TreePHP.declare_statement_return declare_statement() throws RecognitionException {
		...
		try {
			// TreePHP.g:1150:3: ( ^( BLOCK ( inner_statement_list )? ) )
			// TreePHP.g:1150:5: ^( BLOCK ( inner_statement_list )? )
			{
			root_0 = (AST)adaptor.nil();
			...
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// TreePHP.g:1150:13: ( inner_statement_list )?
				int alt56=2;
	...
	// TreePHP.g:1163:1: parameter_list returns [List parameterList] : ( parameter )+ ;
	public final TreePHP.parameter_list_return parameter_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1170:3: ( ( parameter )+ )
			// TreePHP.g:1170:5: ( parameter )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1176:1: parameter : ^( PARAMETER ( ^( TYPE parameter_type ) )? ( CONST_T )? pure_variable ( scalar )? ) ;
	public final TreePHP.parameter_return parameter() throws RecognitionException {
		...
		try {
			// TreePHP.g:1177:3: ( ^( PARAMETER ( ^( TYPE parameter_type ) )? ( CONST_T )? pure_variable ( scalar )? ) )
			// TreePHP.g:1177:5: ^( PARAMETER ( ^( TYPE parameter_type ) )? ( CONST_T )? pure_variable ( scalar )? )
			{
			root_0 = (AST)adaptor.nil();
			...
			match(input, Token.DOWN, null); 
			// TreePHP.g:1177:17: ( ^( TYPE parameter_type ) )?
			int alt58=2;
			...
			switch (alt58) {
				case 1 :
					// TreePHP.g:1177:18: ^( TYPE parameter_type )
					{
					_last = (AST)input.LT(1);
					{
					AST _save_last_2 = _last;
	...
	// TreePHP.g:1212:1: parameter_type returns [TypeReference type] : ( fully_qualified_class_name | cast_option );
	public final TreePHP.parameter_type_return parameter_type() throws RecognitionException {
		...
		try {
			// TreePHP.g:1213:3: ( fully_qualified_class_name | cast_option )
			int alt61=2;
			...
			switch (alt61) {
				case 1 :
					// TreePHP.g:1213:5: fully_qualified_class_name
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1225:1: variable_modifiers : ( 'var' | modifier );
	...
	// TreePHP.g:1230:1: modifier returns [ModifierDocPair modifierVar] : ( 'public' | 'protected' | 'private' | 'static' | 'abstract' | 'final' )+ ;
	public final TreePHP.modifier_return modifier() throws RecognitionException {
		...
		try {
			// TreePHP.g:1237:3: ( ( 'public' | 'protected' | 'private' | 'static' | 'abstract' | 'final' )+ )
			// TreePHP.g:1237:5: ( 'public' | 'protected' | 'private' | 'static' | 'abstract' | 'final' )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1249:1: directive returns [Object astNode] : ^( EQUAL_T IDENTIFIER expression ) ;
	public final TreePHP.directive_return directive() throws RecognitionException {
		...
		try {
			// TreePHP.g:1250:3: ( ^( EQUAL_T IDENTIFIER expression ) )
			// TreePHP.g:1250:5: ^( EQUAL_T IDENTIFIER expression )
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1271:1: expr_list returns [List exprList] : ( expression )+ ;
	public final TreePHP.expr_list_return expr_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1282:2: ( ( expression )+ )
			// TreePHP.g:1282:4: ( expression )+
			{
			root_0 = (AST)adaptor.nil();
	...
	public final TreePHP.expression_return expression() throws RecognitionException {
		...
		try {
			// TreePHP.g:1297:3: ( ^( EXPR etop= expression ) | ^( OR_T e1= expression e2= expression ) | ^( XOR_T e1= expression e2= expression ) | ^( AND_T e1= expression e2= expression ) | ^( EQUAL_T e1= expression e2= expression ) | ^( PLUS_EQ e1= expression e2= expression ) | ^( MINUS_EQ e1= expression e2= expression ) | ^( MUL_EQ e1= expression e2= expression ) | ^( DIV_EQ e1= expression e2= expression ) | ^( DOT_EQ e1= expression e2= expression ) | ^( PERCENT_EQ e1= expression e2= expression ) | ^( BIT_AND_EQ e1= expression e2= expression ) | ^( BIT_OR_EQ e1= expression e2= expression ) | ^( POWER_EQ e1= expression e2= expression ) | ^( LMOVE_EQ e1= expression e2= expression ) | ^( RMOVE_EQ e1= expression e2= expression ) | ^( QUESTION_T e1= expression ^( COLON_T e2= expression e3= expression ) ) | ^( LOGICAL_OR_T e1= expression e2= expression ) | ^( LOGICAL_AND_T e1= expression e2= expression ) | ^( BIT_OR_T e1= expression e2= expression ) | ^( POWER_T e1= expression e2= expression ) | ^( REF_T e1= expression e2= expression ) | ^( UNARY_EXPR unary_symbol_list e= expression ) | ^( DOT_T e1= expression e2= expression ) | ^( EQUAL_EQUAL_T e1= expression e2= expression ) | ^( NOT_EQUAL_T e1= expression e2= expression ) | ^( EQUAL_EQUAL_EQUAL_T e1= expression e2= expression ) | ^( NOT_EQUAL_EQUAL_T e1= expression e2= expression ) | ^( LT_T e1= expression e2= expression ) | ^( MT_T e1= expression e2= expression ) | ^( LE_T e1= expression e2= expression ) | ^( ME_T e1= expression e2= expression ) | ^( LSHIFT_T e1= expression e2= expression ) | ^( RSHIFT_T e1= expression e2= expression ) | ^( PLUS_T e1= expression e2= expression ) | ^( MINUS_T e1= expression e2= expression ) | ^( MUL_T e1= expression e2= expression ) | ^( DIV_T e1= expression e2= expression ) | ^( PERCENT_T e1= expression e2= expression ) | ^( CAST_EXPR cast_option e= expression ) | ^( POSTFIX_EXPR e= expression plus_minus ) | ^( PREFIX_EXPR ( plus_minus )+ e= expression ) | ^( INSTANCEOF_T e= expression class_name_reference ) | ( AT_T )? variable | ( AT_T )? scalar | list_decl | ^( ARRAY_DECL ( array_pair_list )? ) | ^( NEW_T class_name_reference ) | ^( CLONE_T variable ) | ^( UNSET_T variable_list ) | BACKTRICKLITERAL | ^( PRINT_T e= expression ) )
			int alt69=52;
			switch ( input.LA(1) ) {
			case EXPR:
				{
			...
			switch (alt69) {
				case 1 :
					// TreePHP.g:1297:5: ^( EXPR etop= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:1305:5: ^( OR_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 3 :
					// TreePHP.g:1313:5: ^( XOR_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:1321:5: ^( AND_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 5 :
					// TreePHP.g:1329:5: ^( EQUAL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 6 :
					// TreePHP.g:1342:5: ^( PLUS_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 7 :
					// TreePHP.g:1350:5: ^( MINUS_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 8 :
					// TreePHP.g:1358:5: ^( MUL_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 9 :
					// TreePHP.g:1366:5: ^( DIV_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 10 :
					// TreePHP.g:1374:5: ^( DOT_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 11 :
					// TreePHP.g:1382:5: ^( PERCENT_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 12 :
					// TreePHP.g:1390:5: ^( BIT_AND_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 13 :
					// TreePHP.g:1398:5: ^( BIT_OR_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 14 :
					// TreePHP.g:1406:5: ^( POWER_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 15 :
					// TreePHP.g:1414:5: ^( LMOVE_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 16 :
					// TreePHP.g:1422:5: ^( RMOVE_EQ e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 17 :
					// TreePHP.g:1430:5: ^( QUESTION_T e1= expression ^( COLON_T e2= expression e3= expression ) )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 18 :
					// TreePHP.g:1436:5: ^( LOGICAL_OR_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 19 :
					// TreePHP.g:1444:5: ^( LOGICAL_AND_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 20 :
					// TreePHP.g:1452:5: ^( BIT_OR_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 21 :
					// TreePHP.g:1460:5: ^( POWER_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 22 :
					// TreePHP.g:1468:5: ^( REF_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 23 :
					// TreePHP.g:1481:5: ^( UNARY_EXPR unary_symbol_list e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 24 :
					// TreePHP.g:1513:5: ^( DOT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 25 :
					// TreePHP.g:1521:5: ^( EQUAL_EQUAL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 26 :
					// TreePHP.g:1529:5: ^( NOT_EQUAL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 27 :
					// TreePHP.g:1537:5: ^( EQUAL_EQUAL_EQUAL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 28 :
					// TreePHP.g:1545:5: ^( NOT_EQUAL_EQUAL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 29 :
					// TreePHP.g:1553:5: ^( LT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 30 :
					// TreePHP.g:1561:5: ^( MT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 31 :
					// TreePHP.g:1569:5: ^( LE_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 32 :
					// TreePHP.g:1577:5: ^( ME_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 33 :
					// TreePHP.g:1585:5: ^( LSHIFT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 34 :
					// TreePHP.g:1593:5: ^( RSHIFT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 35 :
					// TreePHP.g:1601:5: ^( PLUS_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 36 :
					// TreePHP.g:1614:5: ^( MINUS_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 37 :
					// TreePHP.g:1627:5: ^( MUL_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 38 :
					// TreePHP.g:1635:5: ^( DIV_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 39 :
					// TreePHP.g:1643:5: ^( PERCENT_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 40 :
					// TreePHP.g:1651:5: ^( CAST_EXPR cast_option e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 41 :
					// TreePHP.g:1697:5: ^( POSTFIX_EXPR e= expression plus_minus )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 42 :
					// TreePHP.g:1708:5: ^( PREFIX_EXPR ( plus_minus )+ e= expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 43 :
					// TreePHP.g:1719:5: ^( INSTANCEOF_T e= expression class_name_reference )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 44 :
					// TreePHP.g:1725:5: ( AT_T )? variable
					{
					root_0 = (AST)adaptor.nil();


					// TreePHP.g:1725:5: ( AT_T )?
					int alt66=2;
					...
					break;
				case 45 :
					// TreePHP.g:1729:5: ( AT_T )? scalar
					{
					root_0 = (AST)adaptor.nil();


					// TreePHP.g:1729:5: ( AT_T )?
					int alt67=2;
				...
				case 46 :
					...
					break;
				case 47 :
					// TreePHP.g:1738:5: ^( ARRAY_DECL ( array_pair_list )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// TreePHP.g:1738:18: ( array_pair_list )?
						int alt68=2;
					...
					break;
				case 48 :
					// TreePHP.g:1749:5: ^( NEW_T class_name_reference )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 49 :
					// TreePHP.g:1765:5: ^( CLONE_T variable )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 50 :
					// TreePHP.g:1772:5: ^( UNSET_T variable_list )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 51 :
					// TreePHP.g:1792:5: BACKTRICKLITERAL
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 52 :
					// TreePHP.g:1798:5: ^( PRINT_T e= expression )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1823:1: unary_symbol_list returns [List symbolList] : ( unary_symbol )+ ;
	public final TreePHP.unary_symbol_list_return unary_symbol_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1830:3: ( ( unary_symbol )+ )
			// TreePHP.g:1830:5: ( unary_symbol )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1836:1: unary_symbol : ( PLUS_T | MINUS_T | REF_T | TILDA_T | EXC_NOT_T );
	public final TreePHP.unary_symbol_return unary_symbol() throws RecognitionException {
		...
		try {
			// TreePHP.g:1837:3: ( PLUS_T | MINUS_T | REF_T | TILDA_T | EXC_NOT_T )
			int alt71=5;
			switch ( input.LA(1) ) {
			case PLUS_T:
				{
	...
	// TreePHP.g:1844:1: plus_minus : ( PLUS_PLUS_T | MINUS_MINUS_T );
	public final TreePHP.plus_minus_return plus_minus() throws RecognitionException {
		...
		try {
			// TreePHP.g:1845:3: ( PLUS_PLUS_T | MINUS_MINUS_T )
			// TreePHP.g:
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1849:1: cast_option returns [int castOption] : ( 'bool' | 'boolean' | 'int' | 'float' | 'double' | 'array' | 'object' | 'real' | 'string' | UNSET_T | CLONE_T );
	public final TreePHP.cast_option_return cast_option() throws RecognitionException {
		...
		try {
			// TreePHP.g:1850:3: ( 'bool' | 'boolean' | 'int' | 'float' | 'double' | 'array' | 'object' | 'real' | 'string' | UNSET_T | CLONE_T )
			int alt72=11;
			switch ( input.LA(1) ) {
			case 186:
				{
	...
	// TreePHP.g:1868:1: class_name_reference returns [Expression var, PHPCallArgumentsList parameterList] : ( dynamic_name_reference | fully_qualified_class_name );
	public final TreePHP.class_name_reference_return class_name_reference() throws RecognitionException {
		...
		try {
			// TreePHP.g:1877:3: ( dynamic_name_reference | fully_qualified_class_name )
			int alt73=2;
			...
			switch (alt73) {
				case 1 :
					// TreePHP.g:1877:5: dynamic_name_reference
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:1890:5: fully_qualified_class_name
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1896:1: dynamic_name_reference returns [Expression var, PHPCallArgumentsList parameterList] : ( base_variable_with_function_calls | ^( CALL v1= dynamic_name_reference obj= object_property ( ctor_arguments )? ) );
	public final TreePHP.dynamic_name_reference_return dynamic_name_reference() throws RecognitionException {
		...
		try {
			// TreePHP.g:1897:3: ( base_variable_with_function_calls | ^( CALL v1= dynamic_name_reference obj= object_property ( ctor_arguments )? ) )
			int alt75=2;
			...
			switch (alt75) {
				case 1 :
					// TreePHP.g:1897:5: base_variable_with_function_calls
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:1905:5: ^( CALL v1= dynamic_name_reference obj= object_property ( ctor_arguments )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:1905:58: ( ctor_arguments )?
					int alt74=2;
	...
	// TreePHP.g:1917:1: list_decl returns [Expression expr] : ^( LIST_T ( assignment_list )? ) ;
	public final TreePHP.list_decl_return list_decl() throws RecognitionException {
		...
		try {
			// TreePHP.g:1918:3: ( ^( LIST_T ( assignment_list )? ) )
			// TreePHP.g:1918:5: ^( LIST_T ( assignment_list )? )
			{
			root_0 = (AST)adaptor.nil();
			...
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// TreePHP.g:1918:14: ( assignment_list )?
				int alt76=2;
	...
	// TreePHP.g:1926:1: assignment_list returns [List assignList] : ( assignment_element )+ ;
	public final TreePHP.assignment_list_return assignment_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1933:3: ( ( assignment_element )+ )
			// TreePHP.g:1933:5: ( assignment_element )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1939:1: assignment_element : ( variable | list_decl );
	public final TreePHP.assignment_element_return assignment_element() throws RecognitionException {
		...
		try {
			// TreePHP.g:1940:3: ( variable | list_decl )
			int alt78=2;
	...
	// TreePHP.g:1950:1: array_pair_list returns [List arrayList] : ( array_pair_element )+ ;
	public final TreePHP.array_pair_list_return array_pair_list() throws RecognitionException {
		...
		try {
			// TreePHP.g:1957:3: ( ( array_pair_element )+ )
			// TreePHP.g:1957:5: ( array_pair_element )+
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1963:1: array_pair_element : ( ^( ARROW_T e1= expression e2= expression ) |e= expression );
	public final TreePHP.array_pair_element_return array_pair_element() throws RecognitionException {
		...
		try {
			// TreePHP.g:1964:3: ( ^( ARROW_T e1= expression e2= expression ) |e= expression )
			int alt80=2;
			...
			switch (alt80) {
				case 1 :
					// TreePHP.g:1964:5: ^( ARROW_T e1= expression e2= expression )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:1983:1: variable returns [Expression var, PHPCallArgumentsList parameterList] : variable_temp ;
	public final TreePHP.variable_return variable() throws RecognitionException {
		...
		try {
			// TreePHP.g:1990:3: ( variable_temp )
			// TreePHP.g:1990:5: variable_temp
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:2012:1: variable_temp returns [Expression var, PHPCallArgumentsList parameterList] : ( base_variable_with_function_calls | ^( CALL v1= variable_temp obj= object_property ( ctor_arguments )? ) );
	public final TreePHP.variable_temp_return variable_temp() throws RecognitionException {
		...
		try {
			// TreePHP.g:2013:3: ( base_variable_with_function_calls | ^( CALL v1= variable_temp obj= object_property ( ctor_arguments )? ) )
			int alt82=2;
			...
			switch (alt82) {
				case 1 :
					// TreePHP.g:2013:5: base_variable_with_function_calls
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:2018:5: ^( CALL v1= variable_temp obj= object_property ( ctor_arguments )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:2018:49: ( ctor_arguments )?
					int alt81=2;
	...
	// TreePHP.g:2044:1: base_variable_with_function_calls returns [Expression var, PHPCallArgumentsList parameterList, TypeReference type, Expression functionInvocation] : ( ^( VAR_DECL ( fully_qualified_class_name )? obj= object_property ( ctor_arguments )? ) | ^( CALL fully_qualified_class_name ctor_arguments ) );
	public final TreePHP.base_variable_with_function_calls_return base_variable_with_function_calls() throws RecognitionException {
		...
		try {
			// TreePHP.g:2045:3: ( ^( VAR_DECL ( fully_qualified_class_name )? obj= object_property ( ctor_arguments )? ) | ^( CALL fully_qualified_class_name ctor_arguments ) )
			int alt85=2;
			...
			switch (alt85) {
				case 1 :
					// TreePHP.g:2045:5: ^( VAR_DECL ( fully_qualified_class_name )? obj= object_property ( ctor_arguments )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					match(input, Token.DOWN, null); 
					// TreePHP.g:2045:16: ( fully_qualified_class_name )?
					int alt83=2;
					...
					// TreePHP.g:2045:64: ( ctor_arguments )?
					int alt84=2;
					...
					break;
				case 2 :
					// TreePHP.g:2072:5: ^( CALL fully_qualified_class_name ctor_arguments )
					{
					root_0 = (AST)adaptor.nil();
	...
	// $ANTLR start "dollars"
	// TreePHP.g:2098:1: dollars returns [int size, String str] : ( DOLLAR_T )* ;
	public final TreePHP.dollars_return dollars() throws RecognitionException {
		...
		try {
			// TreePHP.g:2103:3: ( ( DOLLAR_T )* )
			// TreePHP.g:2103:5: ( DOLLAR_T )*
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:2106:1: object_property returns [String str, Expression expr, SimpleReference simpleRef] : ( ^( VAR dollars IDENTIFIER ) | ^( VAR dollars expression ) | ^( INDEX obj= object_property ( expression )? ) | ^( HASH_INDEX obj= object_property ( expression )? ) );
	public final TreePHP.object_property_return object_property() throws RecognitionException {
		...
		try {
			// TreePHP.g:2115:3: ( ^( VAR dollars IDENTIFIER ) | ^( VAR dollars expression ) | ^( INDEX obj= object_property ( expression )? ) | ^( HASH_INDEX obj= object_property ( expression )? ) )
			int alt89=4;
			alt89 = dfa89.predict(input);
			switch (alt89) {
				case 1 :
					// TreePHP.g:2115:5: ^( VAR dollars IDENTIFIER )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 2 :
					// TreePHP.g:2140:5: ^( VAR dollars expression )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 3 :
					// TreePHP.g:2147:5: ^( INDEX obj= object_property ( expression )? )
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 4 :
					// TreePHP.g:2167:5: ^( HASH_INDEX obj= object_property ( expression )? )
					{
					root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:2193:1: ctor_arguments returns [PHPCallArgumentsList argumentList] : ^( ARGU ( expr_list )? ) ;
	public final TreePHP.ctor_arguments_return ctor_arguments() throws RecognitionException {
		...
		try {
			// TreePHP.g:2200:3: ( ^( ARGU ( expr_list )? ) )
			// TreePHP.g:2200:6: ^( ARGU ( expr_list )? )
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:2219:1: pure_variable returns [String str, Boolean isRef] : ^( VAR_DECL ( REF_T )? ( DOLLAR_T )+ IDENTIFIER ) ;
	public final TreePHP.pure_variable_return pure_variable() throws RecognitionException {
		...
		try {
			// TreePHP.g:2227:3: ( ^( VAR_DECL ( REF_T )? ( DOLLAR_T )+ IDENTIFIER ) )
			// TreePHP.g:2227:5: ^( VAR_DECL ( REF_T )? ( DOLLAR_T )+ IDENTIFIER )
			{
			root_0 = (AST)adaptor.nil();
	...
	// $ANTLR start "scalar"
	// TreePHP.g:2237:1: scalar returns [Expression expr] : ^( SCALAR constant ) ;
	public final TreePHP.scalar_return scalar() throws RecognitionException {
		...
		try {
			// TreePHP.g:2244:3: ( ^( SCALAR constant ) )
			// TreePHP.g:2244:5: ^( SCALAR constant )
			{
			root_0 = (AST)adaptor.nil();
	...
	// TreePHP.g:2256:1: constant returns [Scalar scalar, Expression expr] : ( INTLITERAL | FLOATLITERAL | STRINGLITERAL | REALLITERAL | DOUBLELITERRAL | common_scalar | IDENTIFIER | fully_qualified_class_name | HEREDOC_START (id1= IDENTIFIER ) );
	public final TreePHP.constant_return constant() throws RecognitionException {
		...
		try {
			// TreePHP.g:2257:3: ( INTLITERAL | FLOATLITERAL | STRINGLITERAL | REALLITERAL | DOUBLELITERRAL | common_scalar | IDENTIFIER | fully_qualified_class_name | HEREDOC_START (id1= IDENTIFIER ) )
			int alt93=9;
			switch ( input.LA(1) ) {
			case INTLITERAL:
				{
			...
			switch (alt93) {
				...
				case 2 :
					...
					break;
				case 3 :
					// TreePHP.g:2271:7: STRINGLITERAL
					{
					root_0 = (AST)adaptor.nil();
				...
				case 4 :
					...
					break;
				case 5 :
					// TreePHP.g:2296:7: DOUBLELITERRAL
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 6 :
					// TreePHP.g:2303:7: common_scalar
					{
					root_0 = (AST)adaptor.nil();
				...
				case 7 :
					...
					break;
				case 8 :
					// TreePHP.g:2317:7: fully_qualified_class_name
					{
					root_0 = (AST)adaptor.nil();
					...
					break;
				case 9 :
					// TreePHP.g:2326:6: HEREDOC_START (id1= IDENTIFIER )
					{
					root_0 = (AST)adaptor.nil();
					...
					// TreePHP.g:2326:20: (id1= IDENTIFIER )
					// TreePHP.g:2326:21: id1= IDENTIFIER
					{
					_last = (AST)input.LT(1);
	...
	// TreePHP.g:2369:1: common_scalar : ( '__CLASS__' | '__DIR__' | '__FILE__' | '__FUNCTION__' | '__METHOD__' | '__LINE__' | '__NAMESPACE__' );
	public final TreePHP.common_scalar_return common_scalar() throws RecognitionException {
		...
		try {
			// TreePHP.g:2370:3: ( '__CLASS__' | '__DIR__' | '__FILE__' | '__FUNCTION__' | '__METHOD__' | '__LINE__' | '__NAMESPACE__' )
			// TreePHP.g:
			{
			root_0 = (AST)adaptor.nil();
